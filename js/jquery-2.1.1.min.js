...
} ("undefined" != typeof window ? window : this, function (a, b)
{
    ...
    }, n.extend = n.fn.extend = function ()
    {
        ...
        for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == typeof g || n.isFunction (g) || (g = {}), h === i && (g = this, h--); i > h; h++)if (null != (a = arguments[h]))
        {
        ...
        }, each         : function (a, b, c)
        {
            ...
            if (c)
            {
                if (g)
                {
                    for (; f > e; e++)if (d = b.apply (a[e], c), d === !1)
                    {
                        break
                    }
                }
                ...
                {
                    for (e in a)if (d = b.apply (a[e], c), d === !1)
                    {
                        break
                    }
                }
            ...
            {
                for (; f > e; e++)if (d = b.call (a[e], e, a[e]), d === !1)
                {
                    break
                }
            }
            ...
            {
                for (e in a)if (d = b.call (a[e], e, a[e]), d === !1)
                {
                    break;
                }
            }
    ...
    var t = function (a)
    {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + -new Date, v = a.document, w = 0, x = 0, y = gb (), z = gb (), A = gb (), B = function (a, b)
        {
            ...
            {
                for (var b = 0, c = this.length; c > b; b++)if (this[b] === a)
                {
                    return b;
                }
                return -1
        ...
        }, e = fb.getText = function (a)
        {
            ...
            filter      : {
                    ...
                    } : function (b, c, i)
                    {
                        ...
                        if (q)
                        {
                            ...
                            else
                            {
                                while (l = ++n && l && l[p] || (m = n = 0) || o.pop ())
                                {
                                    if ((h ? l.nodeName.toLowerCase () === r : 1 === l.nodeType) && ++m && (s && ((l[u] || (l[u] = {}))[a] = [w,
                                                                                                                                              m]), l === b))
                                    {
                                        break;
                                    }
                ...
                }, PSEUDO: function (a, b)
                {
                    ...
                    return e[u] ? e (b) : e.length > 1 ? (c = [a, a, "",
                                                               b], d.setFilters.hasOwnProperty (a.toLowerCase ()) ? hb (function (a, c)
                    {
        ...
        function wb (a)
        {
            ...
            else
            {
                ...
                {
                    for (e = ++i; f > e; e++)if (d.relative[a[e].type])
                    {
                        break;
                    }
    ...
    n.extend ({
        ...
        has       : function (a)
        {
            ...
            {
                for (var a = 0; c > a; a++)if (n.contains (this, b[a]))
                {
                    return !0
                }
            })
    ...
    K.uid = 1, K.accepts = n.acceptData, K.prototype = {
        ...
        }, remove : function (a, b)
        {
            ...
            {
                n.isArray (b) ? d = b.concat (b.map (n.camelCase)) : (e = n.camelCase (b), b in g ? d = [b,
                                                                                                         e] : (d = e, d = d in g ? [d] : d.match (E) || [])), c = d.length;
                while (c--)
                {
                    delete g[d[c]]
                }
    ...
    n.extend ({
        ...
        {
            for (var e, f, g, h, i, j, k = b.createDocumentFragment (), l = [], m = 0, o = a.length; o > m; m++)if (e = a[m], e || 0 === e)
            {
                if ("object" === n.type (e))
                {
        ...
        }), h.unqueued++, l.always (function ()
        {
            l.always (function ()
            {
                h.unqueued--, n.queue (a, "fx").length || h.empty.fire ()
                                                                                 ...
                                                                                 o.overflowY], j = n.css (a, "display"), k = "none" === j ? L.get (a, "olddisplay") || tb (a.nodeName) : j, "inline" === k && "none" === n.css (a, "float") && (o.display = "inline-block")), c.overflow && (o.overflow = "hidden", l.always (function ()
        {
    ...
    function Xb (a, b, c)
    {
        ...
        for (Wb (k, j.opts.specialEasing); g > f; f++)if (d = Qb[f].call (j, a, k, j.opts))
        {
            return d;
        }
        ...
        ajax         : function (a, b)
        {
            ...
            if (c = sc (oc, k, b, v))
            {
                v.readyState = 1, i && m.trigger ("ajaxSend", [v,
                                                               k]), k.async && k.timeout > 0 && (g = setTimeout (function ()
                {
                    v.abort ("timeout")
                }, k.timeout));
                try
            ...
            {
                var j, r, s, u, w, x = b;
                2 !== t && (t = 2, g && clearTimeout (g), c = void 0, e = h || "", v.readyState = a > 0 ? 4 : 0, j = a >= 200 && 300 > a || 304 === a, f && (u = uc (k, v, f)), u = vc (k, u, v, j), j ? (k.ifModified && (w = v.getResponseHeader ("Last-Modified"), w && (n.lastModified[d] = w), w = v.getResponseHeader ("etag"), w && (n.etag[d] = w)), 204 === a || "HEAD" === k.type ? x = "nocontent" : 304 === a ? x = "notmodified" : (x = u.state, r = u.data, s = u.error, j = !s)) : (s = x, (a || !x) && (x = "error", 0 > a && (a = 0))), v.status = a, v.statusText = (b || x) + "", j ? o.resolveWith (l, [r,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            x,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            v]) : o.rejectWith (l, [v,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    x,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    s]), v.statusCode (q), q = void 0, i && m.trigger (j ? "ajaxSuccess" : "ajaxError", [v,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         k,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         j ? r : s]), p.fireWith (l, [v,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      x]), i && (m.trigger ("ajaxComplete", [v,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             k]), --n.active || n.event.trigger ("ajaxStop")))
            }
